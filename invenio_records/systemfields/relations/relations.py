    ...
    def parse_value(self, value):
        ...
        if isinstance(value, (tuple, list)):
            ...
            for inner_object in value:
                ...
                if inner_v:
                    parsed_values.append(inner_v)

            return parsed_values
        else:
            raise InvalidRelationValue('Invalid value. Expected list or tuple.')
...
class PKNestedRelation(ListRelation, PKRelation):
    """Primary-key nested relation."""
